...
export default function VerifyCode() {
  ...
  async function callverify(values) {
    try {
      ...
      navigate("/newpassword", { state: { resetCode: values.resetCode } });
  ...
  return (
    <>
      <form onSubmit={verifyForm.handleSubmit} className="w-1/2 mx-auto my-20">
        <div>
          {apiError ? (
            <div
